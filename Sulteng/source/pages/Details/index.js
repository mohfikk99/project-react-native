...
export default Details = ({navigation, route, params}) => {
    ...
    return (
      <View style={{flex: 1}}>
        ...
        <View style={{ padding: 5, marginHorizontal: 6, marginTop: 10, marginBottom: 10, width: undefined, borderRadius: 7, height: 250, backgroundColor: '#990900'}}>
          <Image source={{uri:'https://wisatasulteng.com/assets/img/wisata/'+route.params.data[2]}} style={{width: undefined, height: 220, borderRadius: 7 }}/>
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            <Text style={{textAlign: 'left', fontSize: 18, fontWeight: 'bold',  color: 'white'}}>{route.params.data[0]}</Text>
            <Text style={{ color: 'white',textAlign: 'right', fontStyle: 'italic', fontSize: 10}}>{route.params.data[1]}</Text>
          </View>
        </View>
